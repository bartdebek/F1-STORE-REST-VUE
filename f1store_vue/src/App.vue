  ...
  <div id="wrapper">
    <nav class="navbar is-dark">
      <div class="navbar-brand">
        <router-link to="/" class="navbar-item"><strong>F1 Store</strong></router-link>
          ...
          <!-- <div class="navbar-item">
            <form method="get" action="/search">
              <div class="field has-addons">
                <div class="control">
                  <input type="text" class="input" placeholder="Search product" name="query">
                </div>
    ...
    <footer class="footer">
      <p class="has-text-centered">Copyright &copy; Bartosz Dębek 2022</p>
    </footer>
  </div>
</template>
